...
-- P19-A 3.4
-- Forward fix for PL/pgSQL ambiguity between RETURNS TABLE output names
-- and ON CONFLICT column references in the settings experience writer.
-- The applied migration 20260917190000 remains immutable.
