...
export type StoreStrategySettingsRow = {
  ...
  strategy_sell_more_choices?: string[] | null;
  strategy_sell_more_other?: string | null;
  strategy_sale_preference?: string | null;
  strategy_sale_preference_other?: string | null;
  strategy_customer_traits?: string[] | null;
  strategy_customer_traits_other?: string | null;
  strategy_attention_cases?: string[] | null;
  strategy_attention_other?: string | null;
  strategy_sale_value_range?: string | null;
  strategy_sale_value_custom?: string | null;
  strategy_commercial_experience_configured_at?: string | null;
  strategy_priority_deal_types?: string[] | null;
  strategy_priority_deal_types_other?: string | null;
  strategy_avoid_cases?: string[] | null;
  strategy_avoid_cases_other?: string | null;
  strategy_avoid_action?: string | null;
